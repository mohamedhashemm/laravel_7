        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                    <div class="custom-block-image-wrap">
                        <a href="event-detail.html">
                            <img src="<?php echo e(asset('images/anna-rosar-ew-olGvgCCs-unsplash.jpg')); ?>"
                ...
                <div class="col-lg-6 col-12">
                    <div class="custom-block-image-wrap">
                        <a href="event-detail.html">
                            <img src="<?php echo e(asset('images/frederik-rosar-NDSZcCfnsbY-unsplash.jpg')); ?>"
                                class="custom-block-image img-fluid" alt="">
                    ...
                    <div class="col-lg-6 col-12 order-3 order-lg-0">
                        <div class="custom-block-info mt-2 mt-lg-0">
                            ...
                            <p class="mb-0">You can browse many different categories of CSS templates using <a
                                    href="https://templatemo.com/tag" target="_blank">tags</a> on TemplateMo website. Feel
                                free to browse more templates and download them free instantly.</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12 me-auto mb-5 mb-lg-0">
                    <a class="navbar-brand d-flex align-items-center" href="<?php echo e(route('homePage')); ?>">
                        <img src="<?php echo e(asset('images/logo.png')); ?>" class="navbar-brand-image img-fluid" alt="">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\firstProject\resources\views/eventList.blade.php ENDPATH**/ ?>