    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10 m-auto">
                ...
                <form  method="POST" enctype="multipart/form-data" action="<?php echo e(route('product.save')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\firstProject\resources\views/product/create.blade.php ENDPATH**/ ?>