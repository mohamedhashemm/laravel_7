<nav class="menueNav navbar navbar-expand-md navbar-light bg-white shadow-sm">
    <div class="container">
        <a class="navbar-brand ahmed" href="<?php echo e(route('admin.home')); ?>">
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('admin.home')); ?>"><?php echo e(__('language.HOME')); ?></a>
            </li>
            <li class="nav-item">
...
<?php /**PATH C:\laravel\project\resources\views/includes/navbar.blade.php ENDPATH**/ ?>