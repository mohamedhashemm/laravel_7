...
<nav class="menueNav navbar navbar-expand-md navbar-light bg-white shadow-sm">
    <div class="container">
        <a class="navbar-brand ahmed" href="<?php echo e(route('home')); ?>">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('homePage')); ?>"><?php echo e(__('language.HomePage')); ?></a>
                </li>
...
<?php /**PATH C:\laravel\firstProject\resources\views/includes/navbar.blade.php ENDPATH**/ ?>