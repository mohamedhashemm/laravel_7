            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo e(route('category.create')); ?>" class="btn btn-success">Create New Category</a>
                    </div>
                        ...
                        <?php if($ahmed->count() > 0): ?>
                            ...
                            <tbody class="text-center">
                                <?php $__currentLoopData = $ahmed; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <th scope="row">
                                            <img style="width: 80px;padding-top: 30%"
                                                src="<?php echo e(asset('categories/image/' . $x->cate_image)); ?>" alt="no img">
                                        </th>
                                        <th scope="row" style="padding-top: 7%"><?php echo e($x->id); ?></th>
                                        <td scope="row" style="padding-top: 7%"><?php echo e($x->title); ?></td>
                                        <td scope="col" style="padding-top: 7%"><?php echo e($x->description); ?></td>
                                        <td scope="row" style="padding-top: 7%"><?php echo e($x->parent_id); ?></td>
                                        <td scope="row" style="padding-top: 7%"><?php echo e($x->created_at); ?></td>
                                        <td scope="row" style="display: inline-grid;">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo e(route('product.create')); ?>" class="btn btn-success">Create New Product</a>
                    </div>
                            ...
                            <tbody class="text-center">
                                <?php $__currentLoopData = $mohamed; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <th scope="row" style="padding-top: 7%"><?php echo e($x->id); ?></th>
                                        <td scope="row" style="padding-top: 7%"><?php echo e($x->title); ?></td>
                                        <td scope="row" style="padding-top: 7%"><?php echo e($x->description); ?></td>
                                        <td scope="row" style="padding-top: 7%"><?php echo e($x->price); ?></td>
                                        <td scope="row" style="padding-top: 7%"><?php echo e($x->quantity); ?></td>
                                        <td scope="row" style="padding-top: 7%"><?php echo e($x->created_at); ?></td>
                                        <td scope="row" class="">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\blog\resources\views/home.blade.php ENDPATH**/ ?>