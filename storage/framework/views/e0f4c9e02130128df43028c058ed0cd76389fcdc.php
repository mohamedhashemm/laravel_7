<?php $__env->startSection('content'); ?>
    ...
    <?php else: ?>
        <?php echo $__env->make('includes.navTemp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-5 col-12 me-auto mb-4 mb-lg-0">
                        ...
                        <p><strong>Since 1984</strong>, Tiya is ranked #8 in the top 10 golf courses in the world. Tiya is
                            Bootstrap 5 HTML CSS template for golf clubs. Anyone can modify and use this layout for
                            commercial purposes.</p>

                        <p>Tiya Golf Club is 100% free CSS template provided by TemplateMo website. Please tell your friends
                            about our website. Thank you for visiting.</p>
                    </div>

                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mb-md-0">
                        <div class="member-block">
                            <div class="member-block-image-wrap">
                                <img src="<?php echo e(asset('images/members/portrait-young-handsome-businessman-wearing-suit-standing-with-crossed-arms-with-isolated-studio-white-background.jpg')); ?>"
                    ...
                    <div class="col-lg-3 col-md-6 col-12">
                        <div class="member-block">
                            <div class="member-block-image-wrap">
                                <img src="<?php echo e(asset('images/members/successful-asian-lady-boss-red-blazer-holding-clipboard-with-documens-pen-working-looking-happy-white-background.jpg')); ?>"
                                    class="member-block-image img-fluid" alt="">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-5 col-12 mx-auto">
                        ...
                        <form action="<?php echo e(route('addMember')); ?>" enctype="multipart/form-data" method="post"
                            class="custom-form membership-form shadow-lg" role="form">
                            <?php echo csrf_field(); ?>
                            <h4 class="text-white mb-4">Become a member</h4>

                            
                            <?php if(session('addMember')): ?>
                                <h4 class="alert alert-success text-center mt-2"><?php echo e(session('addMember')); ?></h4>
                            <?php endif; ?>
                ...
                <div class="row">
                        ...
                        <div class="col-lg-4 col-md-8 col-12 order-1 order-lg-0">
                            <div class="custom-block-image-wrap">
                                <a href="event-detail.html">
                                    <img src="<?php echo e(asset('images/professional-golf-player.jpg')); ?>"
                    ...
                    <div class="row custom-block custom-block-bg">
                        ...
                        <div class="col-lg-4 col-md-8 col-12 order-1 order-lg-0">
                            <div class="custom-block-image-wrap">
                                <a href="event-detail.html">
                                    <img src="<?php echo e(asset('images/girl-taking-selfie-with-friends-golf-field.jpg')); ?>"
                                        class="custom-block-image img-fluid" alt="">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="contact-info mt-5">
                            ...
                            <img src="<?php echo e(asset('images/WorldMap.svg')); ?>" class="img-fluid" alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12 me-auto mb-5 mb-lg-0">
                        <a class="navbar-brand d-flex align-items-center" href="index.html">
                            <img src="<?php echo e(asset('images/logo.png')); ?>" class="navbar-brand-image img-fluid"
                                alt="">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\firstProject\resources\views/home.blade.php ENDPATH**/ ?>