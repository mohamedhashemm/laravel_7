                ...
                <table class="table table-dark">
                    ...
                    <tbody class="text-center">
                        ...
                        <tr>
                            ...
                            <td scope="row">
                                <a href="<?php echo e(route('cate')); ?>" class="btn btn-success">
                                    Back
                                </a>
                            </td>
                        </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\project\resources\views/category/show.blade.php ENDPATH**/ ?>