...
@section('content')
    ...
    @else
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mb-md-0">
                        <div class="member-block">
                            <div class="member-block-image-wrap">
                                <img src="{{ asset('images/members/portrait-young-handsome-businessman-wearing-suit-standing-with-crossed-arms-with-isolated-studio-white-background.jpg') }}"
                    ...
                    <div class="col-lg-3 col-md-6 col-12">
                        <div class="member-block">
                            <div class="member-block-image-wrap">
                                <img src="{{ asset('images/members/successful-asian-lady-boss-red-blazer-holding-clipboard-with-documens-pen-working-looking-happy-white-background.jpg') }}"
                                    class="member-block-image img-fluid" alt="">
                    ...
                    <div class="col-lg-5 col-12 mx-auto">
                        ...
                        <form action="{{ route('addMember') }}" enctype="multipart/form-data" method="post"
                            ...
                            @if (session('addMember'))
                                <h4 class="alert alert-success text-center mt-2">{{ session('addMember') }}</h4>
                            @endif
                ...
                <div class="row">
                        ...
                        <div class="col-lg-4 col-md-8 col-12 order-1 order-lg-0">
                            <div class="custom-block-image-wrap">
                                <a href="event-detail.html">
                                    <img src="{{ asset('images/professional-golf-player.jpg') }}"
                    ...
                    <div class="row custom-block custom-block-bg">
                        ...
                        <div class="col-lg-4 col-md-8 col-12 order-1 order-lg-0">
                            <div class="custom-block-image-wrap">
                                <a href="event-detail.html">
                                    <img src="{{ asset('images/girl-taking-selfie-with-friends-golf-field.jpg') }}"
                                        class="custom-block-image img-fluid" alt="">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12 me-auto mb-5 mb-lg-0">
                        <a class="navbar-brand d-flex align-items-center" href="{{ route('home') }}">
                            <img src="{{ asset('images/logo.png') }}" class="navbar-brand-image img-fluid"
                                alt="">
        ...
        {{-- @php
                        $scriptPath = public_path('js/jquery.sticky.js');
                    @endphp
